...
function handleSignalSuccess(e) {
	...
	KrollCallBack.title = 'Successful';
...
function handleCallbackDirectly(e) {
	...
	KrollCallBack.callThisCallbackDirectly({
...
function handleRequestData(e) {
	...
	KrollCallBack.requestDataWithCallback();
...
exports.initialize = function(modDevGuide) {
	// Create the proxy
	KrollCallBack = modDevGuide.createKrollCallBack();
	...
	KrollCallBack.registerCallbacks({
	...
	KrollCallBack.addEventListener('demoEvent', demoEventHandler);
}
