...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','ti.sample.test.js')
	...
	f = os.path.join(cwd,'Classes','TiSampleTestModuleAssets.mm')
	c = open(f).read()
	idx = c.find('return ')
	before = c[0:idx]
	after = """
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','ti.sample.test.js']
